...
relo:
                ...
                Catch ex As Exception
                    ...
                    Try
                        Dim tmpChildIe As SHDocVw.InternetExplorerMedium = GetPrintPageSigle()
                        If tmpChildIe IsNot Nothing Then
                            tmpChildIe.Quit()
                        End If
                ...
                'wb.DocumentText = (bodyTxt)
                'wb.Stop()

                Dim flName As String = Pub_Com.pdfPath & csvFileName
...
reloIt:
    ...
    Function GetPrintPageSigle() As SHDocVw.InternetExplorerMedium
    ...
    'Function GetPrintPageHatKekkaPrint() As SHDocVw.InternetExplorerMedium
    ...
    '        Dim filename As String = System.IO.Path.GetFileNameWithoutExtension(childIe.FullName).ToLower()
    '        If filename = "iexplore" Then
    '            If CType(childIe, SHDocVw.InternetExplorerMedium).LocationURL.Contains("HatKekkaPrint.asp") Then
    '                Return childIe
    '            End If
    '        End If
    '    Next

    '    Return GetPrintPageHatKekkaPrint()
...
#End Region
    ...
    Public Function DoStep2_Set(Optional ByVal startIdx As Integer = 0) As Boolean
        ...
        While fra Is Nothing
            Com.Sleep5(1000)
            fra = Pub_Com.GetFrameWait(Ie, "fraHyou")
        End While
